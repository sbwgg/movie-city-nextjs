...
const Index = () => {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            currentScrollY <= 0 && setScrollDown(false);
    ...
    return (
        <header className={classNames([styles.header, isSticky ? styles.headerSticky : scrollDown ? styles.headerDown : ''])}>
            <div className={classNames(styles.headerInner, 'main-container')}>
                <nav className={styles.nav}>
                    <NextLink href="/" className="max-w-[120px]">
                        <svg width="80" height="80" viewBox="0 0 241 214" fill="none" xmlns="http://www.w3.org/2000/svg">
